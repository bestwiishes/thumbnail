...
function appendImages(result) {
    ...
    document.getElementById("hdreslink").href = "https://ifsc-code.in/app2?id=" + result + "&quality=HD";
    document.getElementById("sdreslink").href = "https://ifsc-code.in/app2?id=" + result + "&quality=SD";
    document.getElementById("hqreslink").href = "https://ifsc-code.in/app2?id=" + result + "&quality=HQ";
    document.getElementById("mqreslink").href = "https://ifsc-code.in/app2?id=" + result + "&quality=MQ";
