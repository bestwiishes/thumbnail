...
function appendImages(result) {
    ...
    document.getElementById("hdreslink").href = "https://downloadyoutube-thumbnail.blogspot.com/app2?id=" + result + "&quality=HD";
    document.getElementById("sdreslink").href = "https://downloadyoutube-thumbnail.blogspot.com/app2?id=" + result + "&quality=SD";
    document.getElementById("hqreslink").href = "https://downloadyoutube-thumbnail.blogspot.com/app2?id=" + result + "&quality=HQ";
    document.getElementById("mqreslink").href = "https://downloadyoutube-thumbnail.blogspot.com/app2?id=" + result + "&quality=MQ";
    document.getElementById("defreslink").href = "https://ifsc-code.in/app2?id=" + result + "&quality=def";
